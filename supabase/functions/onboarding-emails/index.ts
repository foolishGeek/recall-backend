          ...
          <tr>
            <td align="center" style="padding:34px 40px 0 40px;">
              ...
              <p style="margin:10px 0 0 0; font-family:Arial,Helvetica,sans-serif; font-size:12px; line-height:1.7; color:#a7a49d;">
                <a href="mailto:contact@ripplelabs.in" class="lnk" style="color:#8A8780; text-decoration:underline;">Help</a>&nbsp;&nbsp;·&nbsp;&nbsp;<a href="https://recall.app/privacy" class="lnk" style="color:#8A8780; text-decoration:underline;">Privacy</a>&nbsp;&nbsp;·&nbsp;&nbsp;<a href="https://recall.app/unsubscribe" class="lnk" style="color:#8A8780; text-decoration:underline;">Unsubscribe</a>
              </p>
            </td>
          </tr>
        </table>
